...
type SystemConfig struct {
	...
	Device *SystemDevice `json:"device" yaml:"device"`
	// Location information about the current location of the device
	Location *SystemLocation `json:"location" yaml:"location"`
	// Debug configuration of the device's debug logs.
	Debug *SystemDebug `json:"debug" yaml:"debug"`
	// UIData user interface data
	UIData *SystemUIData `json:"ui_data" yaml:"ui_data"`
	// RPCUDP configuration for the RPC over UDP
	RPCUDP *SystemRPCUDP `json:"rpc_udp" yaml:"rpc_udp"`
	// Sntp configuration for the sntp server
	Sntp *SystemSntp `json:"sntp" yaml:"sntp"`
	...
	CfgRev *int `json:"cfg_rev" yaml:"cfg_rev"`
}
...
type SystemDevice struct {
	...
	FwID *string `json:"fw_id" yaml:"fw_id"`
	...
	AddonType *string `json:"addon_type" yaml:"addon_type"`
}
...
type SystemDebug struct {
	...
	Mqtt *SystemMqtt `json:"mqtt" yaml:"mqtt"`
	...
	Websocket *SystemWebsocket `json:"websocket" yaml:"websocket"`
	// UDP Configuration of logs streamed over UDP
	UDP *SystemUDP `json:"udp" yaml:"udp"`
}
